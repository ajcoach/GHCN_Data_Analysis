# -*- coding: utf-8 -*-
"""
Created on Sat Sep 1 11:52:43 2021

@author: ajc364
"""

# Starts PySpark shell

start_pyspark_shell


# Loads required Python and PySpark modules
...
# Needed to run file using Spark-submit 
...
stations = (
    ...
    .text("hdfs:////data/ghcnd/ghcnd-stations.txt")
) 
...
states = (
    spark.read.format("text")
    .text("hdfs:////data/ghcnd/ghcnd-states.txt")
)
